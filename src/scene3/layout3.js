...
export const YEARS = [
  {
    year: 2021,
    key: 'Mentoring',
    lines: ['Training & placements', 'Guiding engineers'],
  },
  {
    year: 2022,
    key: 'Cloud',
    lines: ['AWS & Azure certified', 'Teaching the cloud'],
  },
  {
    year: 2023,
    key: 'Research',
    lines: ['PhD in AI begins', 'Deeper questions'],
  },
  {
    year: 2024,
    key: 'IoT',
    lines: ['QIP-PG at IIT Jammu', 'Internet of Things'],
  },
  {
    year: 2025,
    key: 'Impact',
    lines: ['2x AWS, 2x Microsoft', 'Educator awards'],
  },
  {
    year: 2026,
    key: 'Next chapter',
